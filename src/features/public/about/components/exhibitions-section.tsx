...
const exhibitionsData: YearData[] = [
  ...
  },
  {
    ...
    exhibitions: [
      ...
      { venue: 'LibrosArte Gallery "Journey Within" Exhibition, Madrid, Spain', type: 'Solo exhibition', url: 'https://monicaesguevaart.com/monica-esgueva-at-librosarte-journey-within-exhibition-april-2022' },
