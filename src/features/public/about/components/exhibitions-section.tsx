...
const exhibitionsData: YearData[] = [
  ...
  },
  {
    ...
    exhibitions: [
      ...
      { venue: 'China Cultural Center Madrid, Spain', type: 'Group show' },
      { venue: '100 mujeres 100, Tres Cantos, Madrid', type: 'Group show' },
      { venue: 'Art Gallery Inmobiliarias Encuentro, Madrid, Spain', type: 'Solo exhibition' },
  ...
  },
  {
    year: 2022,
    exhibitions: [
      { venue: '8th Toronto Visionary Art Exhibition, Canada', type: 'Group show' },
      { venue: 'Art Number 23 Gallery, Athens, Greece', type: 'Group show' },
      { venue: 'Palazzo Ducale Genova, Italy', type: 'Group show' },
      { venue: 'Galería Galicca, Santiago de Compostela, Spain', type: 'Group show' },
      { venue: 'LibrosArte Gallery "Journey Within" Exhibition, Madrid, Spain', type: 'Mini solo show' },
      { venue: 'Southern California Open Regional Exhibitions, USA', type: 'Group show' },
      { venue: 'LibrosArte Gallery Charity Exhibition, Madrid, Spain', type: 'Group show' },
      { venue: 'Colors of Humanity Gallery, Pennsylvania, USA', type: 'Group show' },
      { venue: 'Contemporary Art Gallery, Delaware, USA', type: 'Group show' },
      { venue: 'BRAIN CAKE at Gaudi Room Casa Mila "La Pedrera", Barcelona, Spain', type: 'Group show' },
      { venue: 'La Laguna Art Gallery, California', type: 'Group show' },
      { venue: 'M.A.D.S. Gallery, Milan, Italy', type: 'Group show' },
      { venue: 'Arte & Paladar, Madrid, Spain', type: 'Solo Exhibition' },
    ...
    publications: [
      ...
      { title: 'Cover on Artist Talk Magazine & 6 plus page interview. Issue #21. UK' },
      { title: 'Cover on Hello ICON Magazine, issue 12 dedicated to Art & Spirituality, USA' },
  ...
  },
  {
    year: 2019,
    exhibitions: [
      { venue: 'Thyssen-Bornemisza Nacional Museum.', type: 'Group show & auction' },
      { venue: 'Asociación Cultural La Guajira, Almería, Spain.', type: 'Solo exhibition' },
      { venue: 'Aeropuerto de Almería, Spain.', type: 'Solo exhibition' },
    ],
  },
  {
    year: 2006,
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="text-muted-foreground space-y-2 text-base leading-relaxed">
                      {yearData.publications.map((publication, idx) => (
                        <li key={idx}>{publication.title}</li>
                      ))}
                    </ul>
                  </div>
                )}
