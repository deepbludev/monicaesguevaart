...
import { logout } from '@/features/admin/auth/actions/auth'
...
export function AdminSidebar() {
  ...
  return (
    <div className="flex w-64 flex-col self-stretch overflow-y-auto border-r bg-gray-100/40 pt-12 dark:bg-gray-800/40">
      <div className="p-6">
